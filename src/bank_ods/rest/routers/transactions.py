...
async def get_transaction_summary(account_id: str, from_date: str, to_date: str):
    return await svc.get_transaction_summary(account_id, from_date, to_date)
...
async def get_transactions(
    ...
    return await svc.get_transactions(account_id, from_date, to_date, status, transaction_type, limit)
